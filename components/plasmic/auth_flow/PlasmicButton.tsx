...
import sty from "./PlasmicButton.module.css"; // plasmic-import: VgnuFTHcwOqi/css
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__o1W56, {
          [sty.freeBoxcolor_neutral__o1W56YxA89]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__o1W566Ec7YUyReU]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxiconEnd__o1W56ZkLSg]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxroundedFull__o1W56ALTg]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__o1W56WqzT8]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__o1W56HhCaf]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__o1W56Tqbjq]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__o1W56GsSqH]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__o1W56UyReU]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__crNgV, {
            [sty.freeBoxcolor_neutral__crNgVYxA89]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__crNgVfoTio]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__crNgVwqzT8]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__crNgVtqbjq]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__crNgVgsSqH]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__crNgVuyReU]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__crNgVBbnmZYxA89]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__lyB04)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__jMdrt, {
            [sty.freeBoxiconEnd__jMdrtZkLSg]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__jMdrTwqzT8]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__jMdrttqbjq]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__jMdrTgsSqH]: hasVariant(
              $state,
              "size",
              "small"
            )
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <ArrowRightSvgrepoCom1Icon
                className={classNames(projectcss.all, sty.svg__fZgH5)}
                role={"img"}
              />
            ),
